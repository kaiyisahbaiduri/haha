...
if (isset($_GET['delete'])) {
	...
	if ($result) {
		echo "<script>alert('Student Deleted Successfully');</script>";
     	echo "<script type='text/javascript'> document.location = 'app_history.php'; </script>";
	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">CT Breakdown</h2>
			</div>
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">All Applied CT</div>
							</div>
			...
			<div class="card-box mb-30">
				...
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus">STUDENT LEVEL</th>
                                  ...
                                  <td><?php $stats=$result->HodRemarks;
								   ...
								   <td>
									  <div class="table-actions">
										<a title="Edit" href="update_form.php?edit=<?php echo htmlentities($result->id);?>" data-color="#265ed7"><i class="dw dw-edit2"></i></a>
									  </div>
								   </td>
							</tr>
							<?php $cnt++;} }?>  
