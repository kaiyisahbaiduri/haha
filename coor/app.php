							...
							<tr>
								...
								<td>
										<div class="table-actions">
											<a title="View" href="app_details.php?leaveid=<?php echo $row['lid']; ?>" data-color="#265ed7"><i class="dw dw-eye"></i></a>
										</div>
									</div>
								</td>
							</tr>
