							...
							<section>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Gender :</label>
											<input name="gender" type="gender" class="form-control" required="true" autocomplete="off" value="<?php echo $row['Gender']; ?>">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_staff" id="add_staff" data-toggle="modal">Update&nbsp;Student</button>
											</div>
										</div>
									</div>
								</div>
