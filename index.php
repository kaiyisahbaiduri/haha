		...
		while ($row = mysqli_fetch_assoc($query)) {
		    ...
		    elseif ($row['role'] == 'Student') {
                ...
                $result = mysqli_query($conn, "UPDATE tblemployees SET status='Online' WHERE emp_id='$emp_id'");
			 	...
			 	echo "<script type='text/javascript'> document.location = 'stud/index.php'; </script>";
		    }
			elseif ($row['role'] == 'HOD') {
		    	$_SESSION['alogin']=$row['emp_id'];
		    	$_SESSION['arole']=$row['role'];
                ...
                $result = mysqli_query($conn, "UPDATE tblemployees SET status='Online' WHERE emp_id='$emp_id'");
			 	...
			 	echo "<script type='text/javascript'> document.location = 'hod/hod_dashboard.php'; </script>";
		    }
		    else {
		    	$_SESSION['alogin']=$row['emp_id'];
		    	$_SESSION['arole']=$row['role'];
                ...
                $result = mysqli_query($conn, "UPDATE tblemployees SET status='Online' WHERE emp_id='$emp_id'");
			 	...
			 	echo "<script type='text/javascript'> document.location = 'coor/index.php'; </script>";
		    }
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/logoMCT.png" alt="">
				</a>
			</div>
		</div>
	</div>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Welcome To Credit Transfer Portal</h2>
						</div>
